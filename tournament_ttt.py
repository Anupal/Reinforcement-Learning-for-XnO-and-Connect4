...
def main():
    ...
    ql_player_x.load_q_table("ql_player_x.pkl")
    ql_player_o.load_q_table("ql_player_o.pkl")
    ...
    if not ql_player_x.q_table or not ql_player_o.q_table:
        ...
        trained_ql_player_x.save_q_table("ql_player_x.pkl")
        trained_ql_player_o.save_q_table("ql_player_o.pkl")
    else:
